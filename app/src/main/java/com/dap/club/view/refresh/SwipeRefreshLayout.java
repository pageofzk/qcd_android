...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final int DEFAULT_TOUCH_SLOP = 160;
    ...
    private boolean discardTouchEvents;
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        if (mTouchSlop < DEFAULT_TOUCH_SLOP) {
            mTouchSlop = DEFAULT_TOUCH_SLOP;
        }
    ...
    public void setScaledTouchTop(int value) {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // 会有一点边缘影响
        mCircleView.layout((width / 2 - circleWidth / 2), mCurrentTargetOffsetTop - 10,
                (width / 2 + circleWidth / 2), mCurrentTargetOffsetTop - 10 + circleHeight);
    }
    ...
    public boolean canChildScrollUp() {
        View childView = mTarget;
        if (mStartDependView != null) {
            childView = mStartDependView;
        }
    ...
    public void setDiscardTouchEvents(boolean flag) {
        discardTouchEvents = flag;
    }

    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (discardTouchEvents) {
