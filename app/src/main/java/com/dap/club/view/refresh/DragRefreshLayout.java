package com.dap.club.view.refresh;
...
public class DragRefreshLayout extends ViewGroup {
    ...
    private static final String LOG_TAG = DragRefreshLayout.class.getSimpleName();
...
//    private float mInitialDownY;
    ...
    /**
     * Auto refresh when the page without data.
     */
...
//                (width / 2 + circleWidth / 2), mCurrentTargetOffsetTop + circleHeight);
        mCircleView.layout(mCurrentTargetOffsetTop, (childHeight / 2 - circleHeight / 2),
                mCurrentTargetOffsetTop + circleWidth, childHeight / 2 + circleHeight / 2);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (!isEnabled() || mReturningToStart || canChildScrollLeft() || mRefreshing) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                setTargetOffsetLeftAndRight(mOriginalOffsetTop - mCircleView.getLeft(), true);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                final float s = MotionEventCompat.getX(ev, pointerIndex);
                final float overscrollTop = (s - mInitialMotionX) * DRAG_RATE;
                if (mIsBeingDragged) {
                    ...
                    int targetX = mOriginalOffsetTop
                    ...
                    setTargetOffsetLeftAndRight(targetX - mCurrentTargetOffsetTop,
                            true /* requires update */);
                }
                break;
            }
            ...
            case MotionEvent.ACTION_CANCEL: {
                ...
                final int pointerIndex = MotionEventCompat.findPointerIndex(ev, mActivePointerId);
                if (pointerIndex < 0) {
                    Log.e(LOG_TAG, "Got ACTION_UP event but have an invalid active pointer id.");
                    return false;
                }
