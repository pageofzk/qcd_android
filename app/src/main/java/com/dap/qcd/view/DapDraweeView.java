 ...
 */
public class DapDraweeView extends SimpleDraweeView implements ImageDisplayer{
...
//            FLog.e(getClass(), throwable, "Error loading %s", id);
            ...
            if (throwable != null) {
                ...
                DapLog.d(" message is: " + throwable.getMessage());
            }
    ...
    public DapDraweeView(Context context, GenericDraweeHierarchy hierarchy) {
        super(context, hierarchy);
    }

    public DapDraweeView(Context context) {
        super(context);
    }

    public DapDraweeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DapDraweeView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public static Uri getTransformedUri(Uri uri, DapDraweeView imageView) {
        Uri ret = null;
...
//        Log.e(TAG, "setUriCompare " + uri.toString() + " " + (getUri() != null ? getUri().toString() : "null"));
    ...
    private void notifyImageLoaded(ImageInfo imageInfo) {
        try {
            if (onImageChangeListenerWeakReference != null && onImageChangeListenerWeakReference.get() != null) {
